      ...
      <main className="max-w-2xl mx-auto px-6 pt-28 pb-20">
        <div className="mb-10">
          ...
          <p className="text-[#8b9cc8] leading-relaxed">
            Scores are generated by <Link href="/tools/prompt-analyzer" className="text-violet-400 hover:text-violet-300 transition-colors">Deepclario&apos;s prompt analyzer</Link> — rated
          ...
          {EXAMPLES.map((ex) => (
            <div key={ex.category}>
              <div className="flex items-center gap-3 mb-5">
                <span className="text-xs font-bold text-violet-400 uppercase tracking-wider px-2.5 py-1 rounded-lg bg-violet-500/10 border border-violet-500/20">
                  {ex.category}
                </span>
                <div className="flex items-center gap-2 text-xs text-[#4a5a80]">
                  <span className="text-red-400 font-bold">{ex.before.score}/100</span>
                  <span>→</span>
                  <span className="text-emerald-400 font-bold">{ex.after.score}/100</span>
                </div>
              </div>

              <div className="space-y-3 mb-4">
                <div className="rounded-xl border border-red-500/20 bg-red-500/5 p-4">
                  <p className="text-xs font-semibold text-red-400 uppercase tracking-wider mb-2">Weak prompt</p>
                  <p className="text-sm text-[#8b9cc8] italic">&ldquo;{ex.before.prompt}&rdquo;</p>
                </div>
                <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4">
                  <p className="text-xs font-semibold text-emerald-400 uppercase tracking-wider mb-2">Strong prompt</p>
                  <p className="text-sm text-[#f0f4ff] leading-relaxed">{ex.after.prompt}</p>
        ...
        <div className="mt-16 pt-8 border-t border-[#1e2d4a] space-y-4">
          <h2 className="text-lg font-bold text-[#f0f4ff]">Analyze your own prompts</h2>

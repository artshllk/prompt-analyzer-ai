...
export default function ExtensionPage() {
  return (
    <div className="editorial grain min-h-screen" style={{ background: 'var(--color-ink)', color: 'var(--color-paper)' }}>
      ...
      <main className="max-w-6xl mx-auto px-6 md:px-10 pt-28 md:pt-36 pb-16 md:pb-24">
        ...
        <section className="mt-24 md:mt-32 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            <TrustChip>Prompts not stored</TrustChip>
            <TrustChip>Only 3 sites</TrustChip>
            <TrustChip>No tracking</TrustChip>
          </div>
          <p className="mt-5 text-sm" style={{ color: 'var(--color-paper-mute)' }}>
            Only activates on ChatGPT, Claude, and Gemini.{' '}

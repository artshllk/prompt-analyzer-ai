...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Yes. The free plan gives you 25 prompt rewrites per month with full clarity scoring and the full rewrite. Pro is $4.99 a month right now (a launch discount from $9.99) and removes the limit, adds full history, persona memory, and weekly insights.',
  },
  {
